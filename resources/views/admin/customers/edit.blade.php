...
@section('content')
	...
	<div class="app-page-title">
		<div class="page-title-wrapper">
			<div class="page-title-heading">
				...
				<div>ITEM CUSTOMER UPDATE FOR {{$customer->customer_number}}
	...
	<div class="row">
		...
		<div class="col-md-12">
			...
			<a href="{{route('customerview.show',['code'=>$customername->code])}}">
	 ...
	 <br><br>
	   ...
	   <div class="row" style="height: 300px">
		...
		<div class="row">
			<div class="col-md-12 pr-md-1">
				<div class="form-group">
					<label>There is no data Customer in List</label>
						...
						<ul><h3>{{$category->title}}</h3>
								...
								<div class="row" style="margin-left: 0px;">
					              ...
					              <div class="col-md-3 pr-md-1" >
					              	...
					              	<div class="col-md-3 pr-md-1" >
					              	  <div class="form-group">	
					              	   @if(session('itemscustomersserials')[0]['itemname_id'] == $item1->itemname_id)	
                                       ...
                                       @endif
										...
										<div class="modal-dialog modal-xl" >
											<div class="modal-content">
												...
												<form method="get" action="{{route('customer.saveserial',['itemname_id'=>$itemname1->id,'store_id'=>$store->id])}}" >
													<div class="modal-body">
          
														<input type="hidden" name="_token" value="{{csrf_token()}}">
														
														<div class="row">
															@if(session('itemscustomersserials')) 
																 @if(session('itemscustomersserials')[0]['itemname_id'] == $item1->itemname_id) 
																   @foreach($item_idscounts as $item_idscountss)
																    @foreach(session('itemscustomersserials')[0]['same_id'] as $itemsserial1)
																   ...
																   @endif
																   @endforeach
																   @foreach(session('itemscustomersserials')[0]['diff_id'] as $itemsserial1)
																   @if($itemsserial1 == $item_idscountss->id)
																     <div class="col-md-2 pr-md-1">
																	<div class="form-group">
                                    ...
                                    <div class="col-md-2 pr-md-1" >
					              	  <div class="form-group">
					              	  	@if(session('itemscustomersmacs')[0]['itemname_id'] == $item1->itemname_id)	
										...
										<div class="modal-dialog modal-xl" >
											<div class="modal-content">
												...
												<form method="get" action="{{route('customer.savemac',['itemname_id'=>$itemname1->id,'store_id'=>$store->id])}}" >
													<div class="modal-body">
          
														<input type="hidden" name="_token" value="{{csrf_token()}}">
														
														<div class="row">
															@if(session('itemscustomersmacs')) 
																 @if(session('itemscustomersmacs')[0]['itemname_id'] == $item1->itemname_id) 
																   @foreach($item_idscounts as $item_idscountmac)

																    @foreach(session('itemscustomersmacs')[0]['same_id'] as $itemsmac1)
																   ...
																   @endif
																   @endforeach
																   @foreach(session('itemscustomersmacs')[0]['diff_id'] as $itemsmac1)
																   @if($itemsmac1 == $item_idscountmac->id)
																     <div class="col-md-2 pr-md-1">
																	<div class="form-group">
 	                                 ...
 	                                 function myFunctionServerC{{$item1->itemname_id}}(){
                                       ...
                                       var store_id = document.getElementsByClassName("store<?php echo $item1->itemname_id; ?>")[0].id;
 	                                   var count = document.getElementById("count<?php echo $item1->itemname_id; ?>").value;
 	                                    ...
 	                                    var url1='{{route("additemscustomercount",[":id",":store_id",":count"])}}';
								  ...
								  <div class="col-md-1 pr-md-1">
                                   ...
                                   <script>
                                       ...
                                       var id = document.getElementsByClassName("get-cartserial<?php echo $item1->itemname_id; ?>")[0].id;
 	                                   ...
 	                                   var url1='{{route("customers.additemcustomerserial",[":id" ,":store_id"])}}';
 	                                   url1 = url1.replace(':id', id);
 	                                   url1 = url1.replace(':store_id', store_id);
								  ...
								  <div class="col-md-1 pr-md-1">
                                   ...
                                   <script>
                                       ...
                                       var id = document.getElementsByClassName("get-cartmac<?php echo $item1->itemname_id; ?>")[0].id;
 	                                   ...
 	                                   var url1='{{route("customer.additemcustomermac",[":id" ,":store_id"])}}';
 	                                   url1 = url1.replace(':id', id);
 	                                   url1 = url1.replace(':store_id', store_id);
					  ...
					  <div class="form-group">
					  	<div class="table-responsive">
							<table class="mb-0 table" style="color:white">
								...
								<tr>
								  <td colspan="6" style="border-top: 1px solid #000; color:white"><h4 align="center">View Selected Items For Customer</h4></td>
							    </tr>
							    <tr>
									  ...
									  @if($store != null)
									   @if($val['store_id']==$store->id)
										...
										<tr>
 	                                    ...
 	                                    var url='{{route("remove_itemcustomersitems",[":id"])}}';
		...
		<div class="row">
			<div class="col-md-10 offset-md-1" >
				<div class="main-card mb-3 card">
					<div class="card-body" style="padding-top:3%;background:#304155">
					  <div class="form-group">
					  	<div class="table-responsive">
							<table class="mb-0 table" style="color:white">
								<thead style="background: #304155;">
								<tr>
								  <td colspan="6" style="border-top: 1px solid #304155; color:white"><h4 align="center">View Selected Stored Items For Customer</h4></td>
							    </tr>
							    <tr>
							    	<td style="color:white;text-align: center;">FTTH</td>
							    	<td style="color:white;text-align: center;">ITEM NAME</td>
							    	...
							    	<td style="color:white;text-align: center;">MAC</td>
							    	<td style="color:white;text-align: center;">SERIAL</td>
							       <!--  <td style="color:white;text-align: center;">REOMOVE</td> -->
							    </tr>
								</thead>
								<tbody>
									@foreach(session('itemscustomersdb') as $k=>$val)
									 @if(is_array($val))
									  @if($store != null)
										...
										<tr>
											...
											<td>{{$val['count']}}</td>
											  ...
											  <td>
												 @foreach($val['itemsserialbyserial'] as $itemval)
												  {{$itemval->serial_number}}
											   
												  @if(\Auth::user()->isSuper() || \Auth::user()->hasPermission("delete-itemcustomer"))
												  <button class="mr-2  btn" data-toggle="modal" data-target=".deleteitem{{$itemval->id}}" title="Delete"><i class="metismenu pe-7s-close-circle" aria-hidden="true" style="color: red"></i></button>
												  <!-- ------------------Delete Item modal Start------------ -->

											<div class="modal fade deleteitem{{$itemval->id}}" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
												<div class="modal-dialog modal-lg">
													<div class="modal-content">
														...
														<form method="get" action="{{route('removeolditemssamdmcustomer',['itemname_id'=>$val['id'],'id'=>$itemval->id,'customer_id'=>$customer->id])}}" >
															<div class="modal-body">
											...
											<!-- ------------------Delete ITEM modal End------------ -->	
										       ...
										       <br>
											     ...
											     @else
											     <td colspan="2">
											     	 @foreach($val['itemsserialbycount'] as $k=>$itemc)
												  <!-- {{$itemc->id}}/ -->{{$k+1}}
												   @if(\Auth::user()->isSuper() || \Auth::user()->hasPermission("delete-itemcustomer"))
											     	 <button class="mr-2 btn-icon btn-icon-only btn btn-outline-danger" data-toggle="modal" data-target=".deleteitemcount{{$itemc->id}}" title="Delete"><i class="metismenu pe-7s-close-circle" aria-hidden="true" style="color: red"></i></button>
                                                     
                                                      <!-- ------------------Delete Item Count modal Start------------ -->

											<div class="modal fade deleteitemcount{{$itemc->id}}" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
												<div class="modal-dialog modal-lg">
													<div class="modal-content">
														<div class="modal-header">
															<h5 class="modal-title" id="exampleModalLongTitle">TO DELETE FOR ITEM NAME {{$val['itemname']}} ITEM {{$k+1}}</h5>

															<button type="button" class="close" data-dismiss="modal" aria-label="Close">
																<span aria-hidden="true">&times;</span>
															</button>
														</div>
														<form method="get" action="{{route('removeolditemssamdmcustomer',['itemname_id'=>$val['id'],'id'=>$itemc->id,'customer_id'=>$customer->id])}}" >
															<div class="modal-body">
						...
						<!---------------------------->
						 ...
						 <div class="row">
								 <div class="col-md-6 pr-md-1">
								    <div class="form-group">
								    	  <a href="{{route('getcustomername_list',['storename'=>$store->name])}}"><label>Click here To get Customer Name Here</label></a>
								    </div>
								</div>
						</div>
						 @else
						 <form method="post" action="{{route('customer.update',['customer_number'=>$customer->customer_number])}}" enctype="multipart/form-data" id="formnameupload">
                           <input type="hidden" name="_token" value="{{csrf_token()}}">
							...
							<div class="row">
								 <div class="col-md-3 pr-md-1">
								    <div class="form-group">
								        ...
								        <select class="form-control" name="customername_id">
								          <option value="{{$customername->id}}">{{$customername->name}}</option> 
								        </select>
								          <a href="{{route('getcustomername_listupdate',['storename'=>$store->name,'customer_id'=>$customer->id])}}"><label>Get Name Here</label></a>
								    </div>
								 </div>
								 <div class="col-md-3 pr-md-1">
								    <div class="form-group">
								        <label> CODE</label>
								         <input type="text" name="customer_code" value="{{$customername->code}}" disabled="" class="form-control">
								    </div>
								 </div>
								  <div class="col-md-2 pr-md-1">
								    <div class="form-group">
								        <label> LATITUDE</label>
								         <input type="text" name="lat" value="{{$customername->lat}}" disabled="" class="form-control">
								    </div>
								 </div>
								  <div class="col-md-2 pr-md-1">
								    <div class="form-group">
								        <label> LONGITUDE</label>
								          <input type="text" name="lng" value="{{$customername->lng}}" disabled="" class="form-control">
								    </div>
								 </div>
								  <div class="col-md-2 pr-md-1">
								    <div class="form-group">
								 ...
								 <div class="col-md-6 pr-md-1">
								    <div class="form-group">
								        <label> STAFF NAME *</label>
										 ...
										 <option value="{{$customer->staff_id}}">{{$customer->staff->name}}</option>
										 @foreach($staffs as  $staff)
										  @if($customer->staff_id != $staff->id)
								    ...
								    <div class="form-group">
								        ...
								        @if($customer->staff_id)
								         <select name="positions" class="form-control" id="positions">
								         	<option>{{$customer->staff->jobtitle['name']}}</option>
								        </select>
								        @else
								       <select name="positions" class="form-control" id="positions">
								        </select>
								 ...
								 <div class="col-md-6 pr-md-1">
								    ...
								    <div class="form-group">
								    	...
								    	@if($customer->customer_sign_file)
					                           <button type="button" class="btn" data-toggle="modal" data-target=".myimage{{$customer->id}}"> <img class="image" src="{{asset('images/ftth/customers/'.$customer->customer_sign_file)}}" alt="" style="border:1px solid#777; background: #fff"></button>
										...
										<div class="modal fade myimage{{$customer->id}}" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
											<div class="modal-dialog modal-lg">
												<div class="modal-content">
													<div class="modal-header">														
													...
													<div class="modal-body">
														 <img src="{{asset('images/ftth/customers/'.$customer->customer_sign_file)}}" class="image2" >
													</div>												
	...
	$(".js-example-tags1").select2({
     ...
     $('select[name="staff_id"]').on('change', function(){
        ...
        if(staff_id) {
            ...
            $.ajax({
            	url: APP_URL+'/admin/ItemsCustomerEntry/getstaffdata/get/'+staff_id,
                type:"GET",
                dataType:"json",
                beforeSend: function(){
