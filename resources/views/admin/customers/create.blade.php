	...
	<div class="row">
		...
		<div class="row">
			...
			<div class="col-md-12">
				...
				<form class="search-bar" action="{{route('customers.search')}}" method="get">
					{{csrf_field()}}
				...
				<div class="main-card mb-3 card">
					<div class="card-body">
						...
						<!---------------------------->
						 ...
						 @else
						 <form method="post" action="{{route('itemcustomercheckout',['store_id'=>$store->id])}} " enctype="multipart/form-data" id="formnameupload">
                           <input type="hidden" name="_token" value="{{csrf_token()}}">
								 ...
								 <div class="col-md-3 pr-md-1">
								    <div class="form-group">
								        ...
								        <select class="form-control" name="customername_id">
								          ...
								          <a href="{{route('getcustomername_list',['storename'=>$store->name])}}"><label>Get Name Here</label></a>
								    </div>
								 </div>
								 <div class="col-md-3 pr-md-1">
								    <div class="form-group">
