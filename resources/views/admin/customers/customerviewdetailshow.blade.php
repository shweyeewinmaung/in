	...
	<div class="app-page-title">
		<div class="page-title-wrapper">
			<div class="page-title-heading">
				...
				<div>{{$code}} Customer For {{$customer_number}}
	...
	<div class="row">
		...
		<div class="col-md-12">
			@if(\Auth::user()->isSuper() || \Auth::user()->hasPermission("view-itemcustomer"))
			   <a href="{{route('customerview.show',['code'=>$code])}}">
						...
						<div class="table-responsive">
							<table class="mb-0 table" >
								<thead style="background: #fff;">
									 <tr>
									 	 <th style="border-bottom: none" rowspan="4">
									 	 	@if($customerdetail->customer_sign_file)
					                           <button type="button" class="btn" data-toggle="modal" data-target=".myimage{{$customerdetail->id}}"> <img class="image" src="{{asset('images/ftth/customers/'.$customerdetail->customer_sign_file)}}" alt="" style="border:1px solid#777; background: #fff"></button>
										...
										<div class="modal fade myimage{{$customerdetail->id}}" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
											<div class="modal-dialog modal-lg">
												<div class="modal-content">
													...
													<div class="modal-body">
														 <img src="{{asset('images/ftth/customers/'.$customerdetail->customer_sign_file)}}" class="image2" >
													</div>												
										...
										<!-- ------------------Picture modal End------------ -->
					                     ...
					                     <th colspan="2" style="border-top: none;border-bottom: none; background: #5a6471;color: #fff;">
					                      	STREET CODE - {{$customerdetail->customer_number}}
					                      </th> 
					                      </tr>
					                      <tr>
					                      <th style="border-top: none;border-bottom: none; background: #5a6471;"><label style="color: #fff;">STORE - {{$customerdetail->store->name}}</label></th>
					                      <th style="border-top: none;border-bottom: none; background: #5a6471;"><label style="color: #fff;">STAFF - {{$customerdetail->staff->name}}</label></th>
					                     </tr>
					                     <tr>
					                      <th style="border-top: none;border-bottom: none; background: #5a6471;"><label style="color: #fff;">STATUS - {{$customerdetail->status}}</label></th>
					                      <th style="border-top: none;border-bottom: none; background: #5a6471;"><label style="color: #fff;">BY -  {{$customerdetail->user->name}}</label></th>
					                     </tr>
					                      <tr>
					                      <th style="border-top: none;border-bottom: none; background: #5a6471;">@if($customerdetail->status =='confirm')<label style="color: #fff;">CONFIRM BY - {{$customerdetail->confirmuser->name}}</label>@endif</th> 
					                      <th style="border-top: none;border-bottom: none; background: #5a6471;"><label style="color: #fff;">CREATED - {{ date('Y-m-d', strtotime($customerdetail->created_at)) }} ({{$customerdetail->created_at->format('H:i:s')}})</label><br><label style="color: #fff;">
					                      UPDATED - {{ date('Y-m-d', strtotime($customerdetail->updated_at)) }} ({{$customerdetail->updated_at->format('H:i:s')}})</label></th>              
									 </tr>
								</thead>
								...
								<table class="table table-bordered" style="background: #2b3c51;color: #fff;">
									...
									<thead style="background: #2b3c51;color: #fff;">
										<tr>
						                     ...
						                     <th>MODEL</th>
						                     <th>DAMAGE</th>
						                     <th>@if(\Auth::user()->isSuper() || \Auth::user()->hasPermission("edit-itemcustomer") ||  \Auth::user()->hasPermission("delete-itemcustomer"))
									   ACTION
									 @endif</th>						                     
						                </tr>									 
									</thead>
											...
											<div class="modal fade edititem{{$itemsm->item_id}}" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
												<div class="modal-dialog modal-lg">
													<div class="modal-content">
									                  ...
									                  <form method="post" action="{{route('ItemByItemCustomerUpdate',['id'=>$itemsm->item_id])}}" enctype="multipart/form-data" >
															<div class="modal-body">
											...
											<div class="modal fade edititemwithcount{{$itemsarray['id']}}" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
												<div class="modal-dialog modal-lg">
													<div class="modal-content">
									                  ...
									                  <form method="post" action="{{route('ItemByItemCustomerCountUpdate',['itemname_id'=>$itemsarray['id'],'customer_id'=>$customerdetail->id])}}" enctype="multipart/form-data" >
															<div class="modal-body">
											...
											<div class="modal fade editredoitemwithcount{{$itemsarray['id']}}" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
												<div class="modal-dialog modal-lg">
													<div class="modal-content">
									                  ...
									                  <form method="post" action="{{route('ItemByItemCustomerRedoCountUpdate',['itemname_id'=>$itemsarray['id'],'customer_id'=>$customerdetail->id])}}" enctype="multipart/form-data" >
															<div class="modal-body">
