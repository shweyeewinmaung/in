...
@section('content')
	...
	<div class="app-page-title">
		<div class="page-title-wrapper">
			<div class="page-title-heading">
				...
				<div>ITEM TRANSFER UPDATE FOR {{$transfer->transfer_number}}
	...
	<div class="row">
		...
		<div class="col-md-12">
			...
			<a href="{{route('transferview.show',['id'=>$transfer->store->id,'name'=>$transfer->store->name])}}">
	   ...
	   <div class="row" style="height: 300px">
		...
		<div class="row">
			<div class="col-md-12 pr-md-1">
				<div class="form-group">
					<label>There is no data Transfer in List</label>
						...
						<ul><h3>{{$category->title}}</h3>
								...
								<div class="row" style="margin-left: 0px;">
					              ...
					              <div class="col-md-3 pr-md-1" >
					              	...
					              	<div class="col-md-3 pr-md-1" >
					              	  <div class="form-group">	
					              	   @if(session('itemstransfersserials')[0]['itemname_id'] == $item1->itemname_id)	
                                       ...
                                       @endif
										...
										<div class="modal-dialog modal-xl" >
											<div class="modal-content">
												...
												<form method="get" action="{{route('transfer.saveserial',['itemname_id'=>$itemname1->id,'store_id'=>$store->id])}}" >
													<div class="modal-body">
          
														<input type="hidden" name="_token" value="{{csrf_token()}}">
														
														<div class="row">
															@if(session('itemstransfersserials')) 
																 @if(session('itemstransfersserials')[0]['itemname_id'] == $item1->itemname_id) 
																   @foreach($item_idscounts as $item_idscountss)
																    @foreach(session('itemstransfersserials')[0]['same_id'] as $itemsserial1)
																   ...
																   @endif
																   @endforeach
																   @foreach(session('itemstransfersserials')[0]['diff_id'] as $itemsserial1)
																   @if($itemsserial1 == $item_idscountss->id)
																     <div class="col-md-2 pr-md-1">
																	<div class="form-group">
                                    ...
                                    <div class="col-md-2 pr-md-1" >
					              	  <div class="form-group">
					              	  	@if(session('itemstransfersmacs')[0]['itemname_id'] == $item1->itemname_id)	
										...
										<div class="modal-dialog modal-xl" >
											<div class="modal-content">
												...
												<form method="get" action="{{route('transfer.savemac',['itemname_id'=>$itemname1->id,'store_id'=>$store->id])}}" >
													<div class="modal-body">
          
														<input type="hidden" name="_token" value="{{csrf_token()}}">
														
														<div class="row">
															@if(session('itemstransfersmacs')) 
																 @if(session('itemstransfersmacs')[0]['itemname_id'] == $item1->itemname_id) 
																   @foreach($item_idscounts as $item_idscountmac)

																    @foreach(session('itemstransfersmacs')[0]['same_id'] as $itemsmac1)
																   ...
																   @endif
																   @endforeach
																   @foreach(session('itemstransfersmacs')[0]['diff_id'] as $itemsmac1)
																   @if($itemsmac1 == $item_idscountmac->id)
																     <div class="col-md-2 pr-md-1">
																	<div class="form-group">
 	                                 ...
 	                                 function myFunctionServerC{{$item1->itemname_id}}(){
                                       ...
                                       var store_id = document.getElementsByClassName("store<?php echo $item1->itemname_id; ?>")[0].id;
 	                                   var count = document.getElementById("count<?php echo $item1->itemname_id; ?>").value;
 	                                    ...
 	                                    var url1='{{route("additemstransfercount",[":id",":store_id",":count"])}}';
								  ...
								  <div class="col-md-1 pr-md-1">
                                   ...
                                   <script>
                                       ...
                                       var id = document.getElementsByClassName("get-cartserial<?php echo $item1->itemname_id; ?>")[0].id;
 	                                   ...
 	                                   var url1='{{route("transfers.additemtransferserial",[":id" ,":store_id"])}}';
 	                                   url1 = url1.replace(':id', id);
 	                                   url1 = url1.replace(':store_id', store_id);
								  ...
								  <div class="col-md-1 pr-md-1">
                                   ...
                                   <script>
                                       ...
                                       var id = document.getElementsByClassName("get-cartmac<?php echo $item1->itemname_id; ?>")[0].id;
 	                                   ...
 	                                   var url1='{{route("transfer.additemtransfermac",[":id" ,":store_id"])}}';
 	                                   url1 = url1.replace(':id', id);
 	                                   url1 = url1.replace(':store_id', store_id);
									  ...
									  @if($store != null)
									   @if($val['store_id']==$store->id)
										...
										<tr>
 	                                    ...
 	                                    var url='{{route("remove_itemtransfersitems",[":id"])}}';
					  ...
					  <div class="form-group">
					  	<div class="table-responsive">
							<table class="mb-0 table" style="color:white">
								...
								<tr>
								  <td colspan="6" style="border-top: 1px solid #304155; color:white"><h4 align="center">View Selected Stored Items For Transfer</h4></td>
							    </tr>
							    <tr>
							    	<td style="color:white;text-align: center;">FTTH</td>
							    	<td style="color:white;text-align: center;">ITEM NAME</td>
								...
								<tbody>
									@foreach(session('itemstransfersdb') as $k=>$val)
									 @if(is_array($val))
									  @if($store != null)
											...
											<div class="modal fade deleteitem{{$itemval->id}}" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
												<div class="modal-dialog modal-lg">
													<div class="modal-content">
														...
														<form method="get" action="{{route('removeolditemssamdmtransfer',['itemname_id'=>$val['id'],'id'=>$itemval->id,'transfer_id'=>$transfer->id])}}" >
															<div class="modal-body">
											...
											<div class="modal fade deleteitemcount{{$itemc->id}}" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
												<div class="modal-dialog modal-lg">
													<div class="modal-content">
														...
														<form method="get" action="{{route('removeolditemssamdmtransfer',['itemname_id'=>$val['id'],'id'=>$itemc->id,'transfer_id'=>$transfer->id])}}" >
															<div class="modal-body">
				...
				<div class="main-card mb-3 card">
					<div class="card-body">
						...
						<!---------------------------->
						 ...
						 <form method="post" action="{{route('transfer.update',['transfer_number'=>$transfer->transfer_number])}}" enctype="multipart/form-data" id="formnameupload">
                           <input type="hidden" name="_token" value="{{csrf_token()}}">
								 ...
								 <div class="col-md-6 pr-md-1">
								    <div class="form-group">
								        <label> FROM *</label>
					                          ...
					                          <input type="text" class="form-control" value="{{$store->name}}" name="from" readonly="readonly">
								    ...
								    <div class="form-group">
								        <label> TO *</label>
								         <select class="form-control" name="to">
								         	<option value="{{$transfer->to}}">{{$transfer->storeto->name}}</option>
									       	@foreach($stores as $store2)
                                            
									       	@if($store2->id != $transfer->to && $store2->id != $store->id)
								 ...
								 <div class="col-md-6 pr-md-1">
								    <div class="form-group">
								        ...
								        <select type="select"name="staff_id" id="staff_id" class="form-control js-example-tags1 custom-select" >
										 <option value="{{$transfer->staff_id}}">{{$transfer->staff->name}}</option>
										 @foreach($staffs as  $staff)
										  @if($transfer->staff_id != $staff->id)
								    ...
								    <div class="form-group">
								        ...
								        @if($transfer->staff_id)
								         <select name="positions" class="form-control" id="positions">
								         	<option>{{$transfer->staff->jobtitle['name']}}</option>
								        </select>
								        @else
								       <select name="positions" class="form-control" id="positions">
								        </select>
								...
								<div class="col-md-6 pr-md-1">
								    <div class="form-group">
								        ...
								        <select type="select"name="status" class="form-control" >
										 <option value="{{$transfer->status}}">{{$transfer->status}}</option>	
										</select>
								    </div>
								 </div>
								 <div class="col-md-6 pr-md-1">
								    <div class="form-group">
								        <label>  CONTENT</label>
								         <textarea rows="3" cols="80" class="form-control"   name="content">{{$transfer->content}}</textarea>
								    </div>
								 </div>
							</div>
								<div class="row">
								 <div class="col-md-6 pr-md-1">
								    ...
								    <div class="form-group">
								    	...
								    	@if($transfer->transfer_sign_file)
					                           <button type="button" class="btn" data-toggle="modal" data-target=".myimage{{$transfer->id}}"> <img class="image" src="{{asset('images/ftth/transfers/'.$transfer->transfer_sign_file)}}" alt="" style="border:1px solid#777; background: #fff"></button>
										...
										<div class="modal fade myimage{{$transfer->id}}" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
											<div class="modal-dialog modal-lg">
												<div class="modal-content">
													<div class="modal-header">														
													...
													<div class="modal-body">
														 <img src="{{asset('images/ftth/transfers/'.$transfer->transfer_sign_file)}}" class="image2" >
													</div>												
	...
	$(".js-example-tags1").select2({
     ...
     $('select[name="staff_id"]').on('change', function(){
        ...
        if(staff_id) {
            ...
            $.ajax({
            	url: APP_URL+'/admin/ItemsTransferEntry/getstaffdata/get/'+staff_id,
                type:"GET",
                dataType:"json",
                beforeSend: function(){
