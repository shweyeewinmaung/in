	...
	<div class="row">
		...
		<div class="row">
			...
			<div class="col-md-12">
				...
				<form class="search-bar" action="{{route('transfers.search')}}" method="get">
					{{csrf_field()}}
				...
				<div class="main-card mb-3 card">
					<div class="card-body">
						...
						<!---------------------------->
						 ...
						 <form method="post" action="{{route('itemtransfercheckout',['store_id'=>$store->id])}} " enctype="multipart/form-data" id="formnameupload">
                           <input type="hidden" name="_token" value="{{csrf_token()}}">
							...
							<div class="row">
								 <div class="col-md-6 pr-md-1">
								    <div class="form-group">
								        <label> FROM *</label>
								        	@if($s == !null)
					                         <input type="text" class="form-control" value="{{$s}}" name="from" readonly="readonly">
					                         @elseif($store !=null)
								    ...
								    <div class="form-group">
								        <label> TO *</label>
								         <select class="form-control" name="to">
									       	...
									       	@if($store2->name != $s || $store2->name != $store->name)
							...
							<div class="row">
								<div class="col-md-6 pr-md-1">
								 ...
								 <div class="col-md-6 pr-md-1">
								    <div class="form-group">
								        <label>  CONTENT</label>
								         <textarea rows="3" cols="80" class="form-control"   name="content"></textarea>
								    </div>
								 </div>
							</div>
								<div class="row">
