	...
	<div class="row">
		...
		<div class="row">
			...
			<div class="col-md-12">
				...
				<form class="search-bar" action="{{route('streets.search')}}" method="get">
					{{csrf_field()}}
			...
			<div class="col-md-12">
				<div class="main-card mb-3 card">
					<div class="card-body">
						@if($store != null)
						<!---------------------------->
						<form method="post" action="{{route('itemstreetcheckout',['store_id'=>$store->id])}}" enctype="multipart/form-data" id="formnameupload">
                           <input type="hidden" name="_token" value="{{csrf_token()}}">
								 ...
								 <div class="col-md-6 pr-md-1">
								    <div class="form-group">
								        ...
								        <select type="select"name="streetname_id" id="streetname_id" class="form-control js-example-tags custom-select" >
										 <option value="">Click here for Street Name</option>
	...
	$(".js-example-tags1").select2({
     ...
     $('select[name="staff_id"]').on('change', function(){
        ...
        if(staff_id) {
            ...
            $.ajax({
            	url: APP_URL+'/admin/ItemsStreetEntry/getstaffdata/get/'+staff_id,
                type:"GET",
                dataType:"json",
                beforeSend: function(){
