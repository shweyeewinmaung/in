...
@section('content')
	...
	<div class="app-page-title">
		<div class="page-title-wrapper">
			<div class="page-title-heading">
				...
				<div>ITEM STREET UPDATE FOR {{$street->street_number}}
	...
	<div class="row">
		...
		<div class="col-md-12">
			...
			<a href="{{route('streetview.show',['name'=>$street->streetname->name])}}">
	   ...
	   <div class="row" style="height: 300px">
		...
		<div class="row">
			<div class="col-md-12 pr-md-1">
				<div class="form-group">
					<label>There is no data Street in List</label>
						...
						<ul><h3>{{$category->title}}</h3>
								...
								<div class="row" style="margin-left: 0px;">
					              ...
					              <div class="col-md-3 pr-md-1" >
					              	...
					              	<div class="col-md-3 pr-md-1" >
					              	  <div class="form-group">	
					              	   @if(session('itemsstreetsserials')[0]['itemname_id'] == $item1->itemname_id)	
                                       ...
                                       @endif
										...
										<div class="modal-dialog modal-xl" >
											<div class="modal-content">
												...
												<form method="get" action="{{route('street.saveserial',['itemname_id'=>$itemname1->id,'store_id'=>$store->id])}}" >
													<div class="modal-body">
          
														<input type="hidden" name="_token" value="{{csrf_token()}}">
														
														<div class="row">
															@if(session('itemsstreetsserials')) 
																 @if(session('itemsstreetsserials')[0]['itemname_id'] == $item1->itemname_id) 
																   @foreach($item_idscounts as $item_idscountss)
																    @foreach(session('itemsstreetsserials')[0]['same_id'] as $itemsserial1)
																   ...
																   @endif
																   @endforeach
																   @foreach(session('itemsstreetsserials')[0]['diff_id'] as $itemsserial1)
																   @if($itemsserial1 == $item_idscountss->id)
																     <div class="col-md-2 pr-md-1">
																	<div class="form-group">
                                    ...
                                    <div class="col-md-2 pr-md-1" >
					              	  <div class="form-group">
					              	  	@if(session('itemsstreetsmacs')[0]['itemname_id'] == $item1->itemname_id)	
										...
										<div class="modal-dialog modal-xl" >
											<div class="modal-content">
												...
												<form method="get" action="{{route('street.savemac',['itemname_id'=>$itemname1->id,'store_id'=>$store->id])}}" >
													<div class="modal-body">
          
														<input type="hidden" name="_token" value="{{csrf_token()}}">
														
														<div class="row">
															@if(session('itemsstreetsmacs')) 
																 @if(session('itemsstreetsmacs')[0]['itemname_id'] == $item1->itemname_id) 
																   @foreach($item_idscounts as $item_idscountmac)

																    @foreach(session('itemsstreetsmacs')[0]['same_id'] as $itemsmac1)
																   ...
																   @endif
																   @endforeach
																   @foreach(session('itemsstreetsmacs')[0]['diff_id'] as $itemsmac1)
																   @if($itemsmac1 == $item_idscountmac->id)
																     <div class="col-md-2 pr-md-1">
																	<div class="form-group">
 	                                 ...
 	                                 function myFunctionServerC{{$item1->itemname_id}}(){
                                       ...
                                       var store_id = document.getElementsByClassName("store<?php echo $item1->itemname_id; ?>")[0].id;
 	                                   var count = document.getElementById("count<?php echo $item1->itemname_id; ?>").value;
 	                                    ...
 	                                    var url1='{{route("additemsstreetcount",[":id",":store_id",":count"])}}';
								  ...
								  <div class="col-md-1 pr-md-1">
                                   ...
                                   <script>
                                       ...
                                       var id = document.getElementsByClassName("get-cartserial<?php echo $item1->itemname_id; ?>")[0].id;
 	                                   ...
 	                                   var url1='{{route("streets.additemstreetserial",[":id" ,":store_id"])}}';
 	                                   url1 = url1.replace(':id', id);
 	                                   url1 = url1.replace(':store_id', store_id);
								  ...
								  <div class="col-md-1 pr-md-1">
                                   ...
                                   <script>
                                       ...
                                       var id = document.getElementsByClassName("get-cartmac<?php echo $item1->itemname_id; ?>")[0].id;
 	                                   ...
 	                                   var url1='{{route("street.additemstreetmac",[":id" ,":store_id"])}}';
 	                                   url1 = url1.replace(':id', id);
 	                                   url1 = url1.replace(':store_id', store_id);
					  ...
					  <div class="form-group">
					  	<div class="table-responsive">
							<table class="mb-0 table" style="color:white">
								...
								<tr>
								  <td colspan="6" style="border-top: 1px solid #000; color:white"><h4 align="center">View Selected Items For Street</h4></td>
							    </tr>
							    <tr>
									  ...
									  @if($store != null)
									   @if($val['store_id']==$store->id)
										<tr>
 	                                    ...
 	                                    var url='{{route("remove_itemstreetsitems",[":id"])}}';
					  ...
					  <div class="form-group">
					  	<div class="table-responsive">
							<table class="mb-0 table" style="color:white">
								...
								<tr>
								  <td colspan="6" style="border-top: 1px solid #304155; color:white"><h4 align="center">View Selected Stored Items For Street</h4></td>
							    </tr>
							    <tr>
							    	<td style="color:white;text-align: center;">FTTH</td>
							    	<td style="color:white;text-align: center;">ITEM NAME</td>
								...
								<tbody>
									@foreach(session('itemsstreetsdb') as $k=>$val)
									 @if(is_array($val))
									  @if($store != null)
											...
											<div class="modal fade deleteitem{{$itemval->id}}" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
												<div class="modal-dialog modal-lg">
													<div class="modal-content">
														...
														<form method="get" action="{{route('removeolditemssamdmstreet',['itemname_id'=>$val['id'],'id'=>$itemval->id,'street_id'=>$street->id])}}" >
															<div class="modal-body">
											...
											<div class="modal fade deleteitemcount{{$itemc->id}}" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
												<div class="modal-dialog modal-lg">
													<div class="modal-content">
														...
														<form method="get" action="{{route('removeolditemssamdmstreet',['itemname_id'=>$val['id'],'id'=>$itemc->id,'street_id'=>$street->id])}}" >
															<div class="modal-body">
			...
			<div class="col-md-12">
				<div class="main-card mb-3 card">
					<div class="card-body">
						...
						<!---------------------------->
						<form method="post" action="{{route('street.update',['street_number'=>$street->street_number])}}" enctype="multipart/form-data" id="formnameupload">
                           <input type="hidden" name="_token" value="{{csrf_token()}}">
							...
							<div class="row">
								 <div class="col-md-6 pr-md-1">
								    <div class="form-group">
								        ...
								        <select type="select"name="streetname_id" id="streetname_id" class="form-control js-example-tags custom-select" >
										 <option value="{{$street->streetname_id}}">{{$street->streetname->name}}</option>
										 @foreach($streetnames as  $streetname)
										 @if($street->streetname_id != $streetname->id)
								 ...
								 <div class="col-md-6 pr-md-1">
								    <div class="form-group">
								        ...
								        <select type="select"name="status" class="form-control" >
										 <option value="{{$street->status}}">{{$street->status}}</option>	
										</select>
								    </div>
								 </div>
							</div>
								 ...
								 <div class="col-md-6 pr-md-1">
								    <div class="form-group">
								        ...
								        <select type="select"name="staff_id" id="staff_id" class="form-control js-example-tags1 custom-select" >
										 <option value="{{$street->staff_id}}">{{$street->staff->name}}</option>
										 @foreach($staffs as  $staff)
										  @if($street->staff_id != $staff->id)
								    ...
								    <div class="form-group">
								        ...
								        @if($street->staff_id)
								         <select name="positions" class="form-control" id="positions">
								         	<option>{{$street->staff->jobtitle['name']}}</option>
								        </select>
								        @else
								       <select name="positions" class="form-control" id="positions">
								        </select>
								 ...
								 <div class="col-md-6 pr-md-1">
								    ...
								    <div class="form-group">
								    	...
								    	@if($street->street_sign_file)
					                           <button type="button" class="btn" data-toggle="modal" data-target=".myimage{{$street->id}}"> <img class="image" src="{{asset('images/ftth/streets/'.$street->street_sign_file)}}" alt="" style="border:1px solid#777; background: #fff"></button>
										...
										<div class="modal fade myimage{{$street->id}}" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
											<div class="modal-dialog modal-lg">
												<div class="modal-content">
													<div class="modal-header">														
													...
													<div class="modal-body">
														 <img src="{{asset('images/ftth/streets/'.$street->street_sign_file)}}" class="image2" >
													</div>												
